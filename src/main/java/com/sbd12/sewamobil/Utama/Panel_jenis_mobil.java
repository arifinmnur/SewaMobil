...
//    public ProdusenmobilJDBCTemplate produsenmobilJDBCTemplate;
    ...
    public Panel_jenis_mobil() throws ClassNotFoundException {
        initComponents();
        ApplicationContext context = new ClassPathXmlApplicationContext("Config-Spring.xml");
        db = (JenisMobilJDBCTemplate) context.getBean("jenisMobilJDBCTemplate");
        jeniss = db.listSemua();
        ...
        jTable1.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                if (e.getClickCount() >= 1) {
                    ...
                    String id_mobil = (String) tabelJenis.getValueAt(baris, 0);
                    System.out.println("id =" + id_mobil);
                    JenisMobil mm = db.pilih_data(id_mobil);
                    old_id_jenis_mobil=mm.getId_jenis_mobil();
                    tf_id_prod.setText(old_id_jenis_mobil);
                    tf_nama_produsen.setText(mm.getNama_jenis_mobil());
                    tf_harga_sewa.setText(String.valueOf(mm.getHarga_mobil()) );
    ...
    public void refreshData() throws ClassNotFoundException {
        jeniss = db.listSemua();
        tabelJenis.setData(jeniss);
        tabelJenis.fireTableDataChanged();
    ...
    private void initComponents() {
        ...
        tf_harga_sewa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tf_harga_sewaActionPerformed(evt);
            }
        });
    ...
    private void BtHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtHapusActionPerformed
        ...
        int baris = jTable1.getSelectedRow();
        String id = (String) tabelJenis.getValueAt(baris, 0);
        String nama = (String) tabelJenis.getValueAt(baris, 1);
    ...
    private void bt_simpan_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_simpan_tambahActionPerformed
        db.create(tf_id_prod.getText().toUpperCase(), tf_nama_produsen.getText(),Double.valueOf(tf_harga_sewa.getText()));
        try {
            refreshData();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Panel_merk_mobil.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void bt_simpan_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_simpan_editActionPerformed
        db.edit(tf_id_prod.getText().toUpperCase(), tf_nama_produsen.getText(),Double.valueOf(tf_harga_sewa.getText()), old_id_jenis_mobil);
        try {
            refreshData();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Panel_merk_mobil.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void tf_harga_sewaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_harga_sewaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tf_harga_sewaActionPerformed
