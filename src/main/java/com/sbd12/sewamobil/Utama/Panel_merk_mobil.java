...
public class Panel_merk_mobil extends javax.swing.JPanel {
    ...
    public void enableInput(boolean enable) {
        ...
        jCb_jenis.setEnabled(enable);
        jCb_produsen.setEnabled(enable);
     ...
     public void resetInput() {
         ...
         jCb_jenis.setSelectedIndex(0);
         jCb_produsen.setSelectedIndex(0);
     }
     ...
     private void setTambah(Boolean tampil, Boolean tambah) {
        ...
        if (tambah) {
            ...
            lb_id_merk.setVisible(tampil);
            tf_id_merk.setVisible(tampil);
        } else if (!tambah) {
    ...
    private void initComponents() {
        ...
        lb_id_merk = new javax.swing.JLabel();
    ...
    private void BtHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtHapusActionPerformed
        ...
        String nama = (String) tableMerk.getValueAt(baris, 3);
        ...
        int jawaban = JOptionPane.showOptionDialog(null, "Anda yakin data "
                + "Mobil dengan Kode" + id + " dengan nama Mobil " + nama + " akan"
    ...
    private javax.swing.JLabel lb_id_merk;
